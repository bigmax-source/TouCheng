...
document.querySelectorAll('[data-site-version]').forEach(el=>el.textContent=siteMeta.version || '1.83');
document.querySelectorAll('[data-site-updated]').forEach(el=>el.textContent=siteMeta.updatedAt || '2026-08-11');
