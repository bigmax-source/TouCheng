...
這是可直接部署至 GitHub Pages 的完整靜態網站。v1.72 延續 v1.71，並完成一批重複事件合併、日期校訂、複合條目拆分及地圖關聯重建。
...
- 新增「頭城古稱就是頭城」、「頭城國小的創設」專題，並補入馬偕九日蘭陽行程。
...
```text
e28ccbd236a79a266193bbf957da02556a31f2848d55d9e755e5a99e6ef83c40
```
